...
> **Règle d'or :** chaque chiffre est adossé à une source (slide 25) ou à une preuve de réflexion assumée. Jamais de « % d'abandon » chiffré.
...
## Slide 2 — Une suite de décisions · *1:00*

Un mot sur la manière dont j'ai construit cette présentation. Je ne vais pas vous montrer une liste de fonctionnalités, mais une **suite de décisions**. Pour chaque brique — produit, économique, technique — je vous donne le problème, les options que j'ai étudiées, le choix retenu, et pourquoi.

---

## Slide 3 — Le problème · *2:00*
...
## Slide 4 — Qu'est-ce qu'un webtoon · *2:50*
...
## Slide 7 — Personas · *5:20*

J'ai identifié quatre personas à partir de données publiques. Ma cible primaire : **Luna**, la créatrice passionnée, prête à mettre 8 à 15 € par mois. Autour d'elle : Marc, l'auteur exigeant ; Théo, l'étudiant prescripteur ; et Elodie, l'éditeur B2B. Tous partagent **le même blocage** : produire des visuels cohérents. Ma décision : commencer par le **B2C**, qui finance l'apprentissage produit et génère les preuves sociales, puis ouvrir le **B2B** — la trajectoire qu'a suivie Dashtoon.

---

## Slide 8 — Concurrence · *6:15*
...
## Slide 9 — Décision fondatrice · *6:55*
...
## Slide 11 — Cinq barrières · *8:30*

Cette slide est la charnière du projet. Cinq barrières empêchent aujourd'hui de créer un webtoon, et à chacune je fais correspondre une réponse. La barrière artistique, c'est la génération IA. L'incohérence, c'est le Sheet System. La fragmentation des outils, le tout-en-un. Le coût, les crédits. La complexité, l'onboarding progressif. De cette correspondance terme à terme découle **toute l'architecture**.

---

## Slide 12 — Onboarding · *9:05*
...
## Slide 13 — Sheet System · *10:15*  ⭐ CŒUR
...
## Slide 14 — Génération par bloc · *10:55*
...
## Slide 16 — Business Model Canvas · *12:20*
...
## Slide 19 — Organisation et juridique · *14:45*

Qui délivre tout ça ? Mon pari : une **personne seule, outillée par l'IA de développement**, peut porter la complexité d'une équipe de trois à cinq. Les recrutements viennent ensuite, déclenchés par des **seuils de revenus**. Même logique côté juridique : auto-entrepreneur, puis **SASU** au premier salarié ou à 30 000 €, puis **SAS** en cas d'associés ou de levée. Chaque transition est déclenchée par un fait. Le développement prend **quatre à six mois**.

---

## Slide 20 — Go To Market · *15:30*
...
## Slide 21 — Stack technique · *16:10*
...
## Slide 22 — Cadre juridique IA · *16:45*

Un sujet que le jury attend : le droit de l'IA. Ma stratégie, c'est d'en faire un **argument commercial**. Trois piliers. Une **intervention humaine créative** à chaque étape, qui sécurise la propriété de l'œuvre. Un **badge de transparence** sur les exports, qui anticipe l'AI Act. Et une **couverture copyright** héritée de FAL.ai. DreamWeave se positionne comme l'outil le plus conforme du secteur.

---

## Slide 23 — Architecture de scale · *17:25*

Et à l'échelle ? Soyons honnêtes. J'ai fait l'exercice inverse d'un pitch : pour chaque composant, je nomme sa **limite actuelle**, et j'y associe une **évolution priorisée** pour passer les dix mille utilisateurs actifs. Mes choix d'aujourd'hui sont des choix de **phase de lancement, pas des impasses**. Le LoRA, par exemple, reste planifié comme une évolution de scale. Chaque limite a déjà son plan de dépassement.

---

## Slide 24 — Conclusion · *18:15*
