  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex flex-1 pt-14 sm:pt-16">
        ...
        <aside className="hidden lg:flex flex-col fixed left-0 top-16 bottom-0 w-[200px] border-r border-border/60 bg-sidebar z-40 overflow-y-auto">
        ...
        {/* Main content */}
        <main className="flex-1 lg:ml-[200px] min-w-0 bg-content flex flex-col">
          <div
