...
| US-5b.5 | En tant qu'utilisateur, je veux que l'IA génère toute mon histoire à partir d'un prompt | - Saisie d'un **prompt** pour le scénario<br>- **Choix du nombre de chapitres** (ex. 50) demandé par l'application<br>- **IA Scénario** génère **toute l'histoire** chapitre par chapitre **directement sur le site** (texte affiché dans l'éditeur) | 🔜 Planifié |
