...
export function AssetCard({
  ...
  return (
    <motion.div
      ...
      className={`glass rounded-xl p-4 group relative ${isCharacter ? "cursor-pointer" : ""}`}
    ...
    >
      ...
      {isCharacter && (
        <p className="text-xs text-primary mt-1">
          Cliquer pour gérer les vues (profil, dos)
        </p>
      )}
      ...
      >
        <button
          ...
          className="p-1.5 rounded-lg bg-primary/90 text-primary-foreground shadow-md
        ...
        {asset.prompt && (
          <button
            ...
            disabled={isGenerating}
            className="p-1.5 rounded-lg bg-amber-500/90 text-white shadow-md
        ...
        <button
          onClick={onDelete}
          disabled={isGenerating}
          className="p-1.5 rounded-lg bg-destructive/90 text-destructive-foreground shadow-md
