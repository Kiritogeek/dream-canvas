      ...
      <div className="relative h-28 sm:h-32 overflow-hidden">
        ...
        {!p.coverUrl && (
          <span className="absolute inset-0 z-10 flex items-center justify-center pointer-events-none">
            <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-black/35 backdrop-blur-sm text-[11px] font-medium text-white/95 shadow-sm">
              <ImageIcon size={12} /> Couverture à générer
            </span>
          </span>
        )}
