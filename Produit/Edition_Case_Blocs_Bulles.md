...
Spécification détaillée : **`Edition_Case_Deux_Modes.md`**.
...
- **Sous-menus d'édition** : `Edition_Case_Deux_Modes.md` — organisation actuelle par Personnalisation / Couleurs / Dialogue.
