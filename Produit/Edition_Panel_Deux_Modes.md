# Édition de panel — Sous-menus d’édition

> Les **images sont générées dans les blocs** du panel. L’implémentation actuelle repose sur une **vue unifiée immersive** : modale plein écran, canvas central **800×H**, colonne gauche par **pictos** (Personnalisation / Couleurs / Dialogue), colonne droite pour le **chapitre textuel**.

---

## 1. Principe : images dans les blocs

- Chaque **panel** est une surface **800×H** (hauteur configurable, bornée) contenant des **blocs**.
...
**Objectif** : éditer les couches non-image du panel.
...
- Canvas panel **centré fixe** (ne se décale pas lors des interactions latérales).
...
| Élément | Détail |
|--------|--------|
| **Visualisation panel** | Éditeur plein écran ; panel centré ; largeur 800 px ; scroll vertical uniquement. |
