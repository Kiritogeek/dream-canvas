      ...
      <div className="space-y-4 sm:space-y-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4 sm:space-y-6">
          <TabsList className="glass w-full sm:w-auto">
            <TabsTrigger value="style" className="flex-1 sm:flex-none">
              <span className="mr-2 inline-flex h-6 w-6 items-center justify-center rounded-full border border-primary/70 bg-primary/10 text-[12px] font-semibold text-primary shadow-sm">
                1
              </span>
              <span>Style</span>
            </TabsTrigger>
            ...
            <TabsTrigger value="scenario" className="flex-1 sm:flex-none">
              <span className="mr-2 inline-flex h-6 w-6 items-center justify-center rounded-full border border-primary/70 bg-primary/10 text-[12px] font-semibold text-primary shadow-sm">
                3
              </span>
              <span>Scénario</span>
            </TabsTrigger>
            <TabsTrigger value="edition" className="flex-1 sm:flex-none">
              <span className="mr-2 inline-flex h-6 w-6 items-center justify-center rounded-full border border-primary/70 bg-primary/10 text-[12px] font-semibold text-primary shadow-sm">
                4
              </span>
              <span>Édition de l'œuvre</span>
            </TabsTrigger>
          </TabsList>
